                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('images.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>TITLE</label>
                                <input type="text" name="title" value="{{ old('title') }}" placeholder="Masukan Judul" class="form-control @error('title') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                <label>CAPTION</label>
                                <input type="text" name="caption" value="{{ old('caption') }}" placeholder="Masukan Caption" class="form-control @error('caption') is-invalid @enderror">
